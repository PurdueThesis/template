\ProvidesFile{ap-numbers.tex}[2022-07-03 numbers, units, and etc. appendix]
...
%xx   \bfseries Input& \bfseries Output& \bfseries Comment\\
%xx   \tabularspace
...

{
  ...
  \ZZbaselinestretch{1}
  \noindent
  \hspace*{2\parindent}\begin{tabular}{@{}lll@{}}
...
These binary prefixes are defined by \pkg{siunitx}
and are used for units related to computers.
\MyIO
...
\begin{VerbatimOut}{z.out}
{
  ...
  \newcolumntype{m}{>{$}r<{$}}
  \noindent
  \hspace*{2\parindent}\begin{tabular}{@{}mllll@{}}
...

{
  ...
  \newcolumntype{m}{>{$}r<{$}}
  \noindent
  \hspace*{2\parindent}\begin{tabular}{@{}mlll@{}}
...
Here is the complete list of units defined by the \pkg{siunitx} package:
...

{
  ...
  \ZZbaselinestretch{1}
  \noindent
  \hspace*{2\parindent}\begin{tabular}{@{}ll@{}}
...
I first tried to do this using the \pkg{siunitx} |\per| command
