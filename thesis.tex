\ProvidesFile{thesis.tex}[2022-07-05 PurdueThesis thesis.tex file]
...
%
% The "d" in, for example, "dx" mathematical integrals should
% use a roman "d".  Use, for example, "\di x" to get "\,mathrm{d}\/x".
%
% Putting e, i, j, and pi in an upright font to indicate they are constants.
% Load the package.
% This loads amsmath.sty (which is already loaded above), mathtools.sty,
% and upgreek.sty.
\usepackage{pa-mismath}
  % Set things up so "e" will be typeset in an upright font.
  % If you use "\enumber" because "e" should usually be in an upright font
  % but sometimes you need a math italic "e" use "\mathit e" to typeset one.
  \enumber
  % Set things up so "i" will be typeset in an upright font.
  % If you use "\inumber" because "i" should usually be in an upright font
  % but sometimes you need a math italic "i" use "\mathit i" to typeset one.
  % \inumber
  % Set things up so "j" will be typeset in an upright font.
  % If you use "\jnumber" because "j" should usually be in an upright font
  % but sometimes you need a math italic "j" use "\mathit j" to typeset one.
  % \jnumber
  % Set things up so "\pi" will be typeset in an upright font.
  % If you use "\pinumber" because "\pi" should usually be in an upright font
  % but sometimes you need a math italic "\pi" use "\itpi".
  \pinumber
