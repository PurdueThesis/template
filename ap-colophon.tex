\ProvidesFile{ap-colophon.tex}[2022-07-08 colophon appendix]
...
\hspace*{2\parindent}\begin{tabular}{@{}ll@{}}
  ...
  \verb+\ZZBibProcessor+& \verb+\ZZBibProcessor+ was computed,\\
                        & now \BibLaTeXLogo\ is used all the time\\
  \verb+\blx@bbxfile+ (bibliography style)& \csname blx@bbxfile\endcsname\\
  \verb+\blx@cbxfile+ (citation style)&  \csname blx@cbxfile\endcsname\\
  \bottomrule
\end{tabular}
\end{VerbatimOut}
